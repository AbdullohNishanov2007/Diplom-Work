...
const Js39Videos = [
  {
    url: "https://www.youtube.com/embed/fHl7UyRjOf0",
    link: "https://www.youtube.com/embed/fHl7UyRjOf0",
    title: " Уроки JavaScript для начинающих / #1 – Введение в язык JS. Что к чему? ",
...
const Js39 = () => {
  ...
  const totalVideos = Js39Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 116, 2),rgb(255, 225, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(201, 174, 0),rgb(203, 78, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 102, 0),rgb(255, 230, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Js39Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(255, 255, 0)'
                  : '0 4px 15px rgb(255, 153, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(219, 190, 0)' : 'rgba(255, 187, 0, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
