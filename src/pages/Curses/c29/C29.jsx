...
const Un29Videos = [
  {
    url: "https://www.youtube.com/embed/g6fw5n9Gt-E",  
    link: "https://www.youtube.com/embed/g6fw5n9Gt-E",
    title: " Изучение Qt Creator | Урок #1 - Графический интерфейс на С++ ",
...
const Un29 = () => {
  ...
  const totalVideos = Un29Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 169, 0),rgb(0, 123, 255))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(0, 102, 210),rgb(14, 122, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 93, 192),rgb(0, 195, 3), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Изучение Qt Creator
          ...
          {Un29Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 141, 0)'
                  : '0 4px 15px rgb(0, 27, 183)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(9, 255, 0)' : 'rgb(0, 39, 231)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
