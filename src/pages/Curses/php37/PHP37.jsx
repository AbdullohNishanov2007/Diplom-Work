...
const Ru36Videos = [
  {
    url: "https://www.youtube.com/embed/xWqssRlGUMA",
    link: "https://www.youtube.com/embed/xWqssRlGUMA",
    title: " Изучение MySQL для начинающих | Урок #1 - Что такое MySQL? ",
...
const Ru36 = () => {
  ...
  const totalVideos = Ru36Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 60, 255),rgb(0, 129, 198))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(0, 200, 255),rgb(49, 66, 255))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 21, 255),rgb(0, 162, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Изучение MySQL для начинающих
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Ru36Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 145, 255)'
                  : '0 4px 15px rgb(17, 0, 255)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 172, 219)' : 'rgba(2, 30, 210, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
