...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/fE1VG1gpXjU",
    link: "https://www.youtube.com/embed/fE1VG1gpXjU",
    title: "Linux для начинающих / Урок #1 – Что такое дистрибутивы, Bash Shell и Ubuntu?",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(195, 195, 195),rgb(176, 0, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(151, 0, 0),rgb(255, 255, 255))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 255, 255),rgb(255, 0, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Li74Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(251, 0, 0)'
                  : '0 4px 15px rgb(147, 147, 147)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 0, 0)' : 'rgb(118, 118, 118)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
