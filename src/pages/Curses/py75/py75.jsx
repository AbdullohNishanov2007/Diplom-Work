...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/_23gclr91P4",
    link: "https://www.youtube.com/embed/_23gclr91P4",
    title: "Изучение Python OpenCV / Урок #1 – Нейронные сети и машинное обучение",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(25, 209, 255),rgb(0, 65, 176))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(0, 48, 151),rgb(0, 101, 145))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 101, 144),rgb(13, 0, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
               Изучение Python OpenCV 
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Li74Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 183, 255)' : 'rgb(0, 17, 255)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
