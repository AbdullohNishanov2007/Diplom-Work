...
const Boot19Videos = [
  {
    ...
    link: "https://www.youtube.com/embed/TZSY6rDUDrE",
    title: " Уроки Bootstrap верстки №1 Основы и установка ",
...
const Boot19 = () => {
  ...
  const totalVideos = Boot19Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(26, 0, 61),rgb(137, 0, 119))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(167, 0, 223),rgb(250, 103, 255))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(56, 0, 79),rgb(202, 104, 255))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Уроки Bootstrap верстки
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Boot19Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgba(123, 0, 180, 0.7)'
                  : '0 4px 15px rgba(112, 61, 149, 0.5)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgba(120, 1, 199, 0.7)' : 'rgba(21, 0, 116, 0.5)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
