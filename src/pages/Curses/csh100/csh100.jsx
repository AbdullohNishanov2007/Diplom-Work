...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/LMHPd9cNLpU",
    link: "https://www.youtube.com/embed/LMHPd9cNLpU",
    title: "  Изучение .NET MAUI для начинающих / Урок #1 – Разработка приложений на C# с нуля  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right, rgb(255, 187, 0), rgb(104, 72, 217))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(255, 200, 0),rgb(63, 33, 172))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(180, 114, 8), rgb(0, 51, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              Разработка приложений на C# с нуля
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
