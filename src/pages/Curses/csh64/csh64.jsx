...
const Csh64Videos = [
  {
    url: "https://www.youtube.com/embed/X2ohiL4cN7c",
    link: "https://www.youtube.com/embed/X2ohiL4cN7c",
    title: "Изучение C# WPF на практике / Урок #1 – Введение в WPF и XAML. Разработка на C#",
...
const Csh64 = () => {
  ...
  const totalVideos = Csh64Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(163, 57, 255),rgb(255, 57, 57))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(170, 0, 99),rgb(48, 0, 192))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 0, 162),rgb(60, 0, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Изучение C# WPF на практике
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Csh64Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(47, 0, 255)'
                  : '0 4px 15px rgb(255, 0, 132)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(89, 0, 255)' : 'rgb(255, 0, 195)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
