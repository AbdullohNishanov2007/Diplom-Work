...
const Un31Videos = [
  {
    url: "https://www.youtube.com/embed/L-FyeHQwo4U",  
    link: "https://www.youtube.com/embed/L-FyeHQwo4U",
    title: " Уроки Django (Создание сайта) / Урок #1 - Введение в фреймворк Django ",
...
const Un31 = () => {
  ...
  const totalVideos = Un31Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(169, 0, 0),rgb(0, 126, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(7, 210, 0),rgb(192, 30, 30))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(192, 0, 0),rgb(0, 195, 3), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Уроки Django Создание сайта
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Un31Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 0, 0)' : 'rgb(46, 231, 0)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
