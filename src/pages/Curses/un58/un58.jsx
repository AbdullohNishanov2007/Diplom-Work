...
const Un58Videos = [
  {
    url: "https://www.youtube.com/embed/VmLLrXlA1xc",
    link: "https://www.youtube.com/embed/VmLLrXlA1xc",
    title: "Дополненная реальность / Создание игры на Unity",
...
const Un58 = () => {
  ...
  const totalVideos = Un58Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 209, 57),rgb(113, 255, 57))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(53, 199, 0),rgb(192, 112, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 123, 0),rgb(60, 255, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Un58Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(123, 255, 0)'
                  : '0 4px 15px rgb(255, 200, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(68, 255, 0)' : 'rgb(255, 174, 0)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
