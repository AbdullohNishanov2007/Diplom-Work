...
const Ja13Videos = [
  {
    url: "https://www.youtube.com/embed/U2OliQwRb6c",
    link: "https://www.youtube.com/embed/U2OliQwRb6c",
    title: " Уроки Java с нуля ",
...
const Ja13 = () => {
  ...
  const totalVideos = Ja13Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(188, 179, 4),rgb(148, 150, 1))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(255, 236, 26),rgb(192, 164, 4))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{ 
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(255, 239, 95),rgb(147, 122, 0))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Ja13Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgba(255, 247, 0, 0.7)'
                  : '0 4px 15px rgba(238, 255, 0, 0.5)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgba(242, 255, 0, 0.7)' : 'rgba(234, 255, 0, 0.5)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
