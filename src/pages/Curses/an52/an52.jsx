...
const An52Videos = [
  {
    url: "https://www.youtube.com/embed/u1VCxpvDgsk",
    link: "https://www.youtube.com/embed/u1VCxpvDgsk",
...
const An52 = () => {
  ...
  const totalVideos = An52Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(212, 212, 212),rgb(255, 0, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(150, 0, 0),rgb(160, 160, 160))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(136, 136, 136),rgb(255, 0, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {An52Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(255, 0, 132)'
                  : '0 4px 15px rgb(196, 196, 196)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 12, 121)' : 'rgba(171, 171, 171, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
