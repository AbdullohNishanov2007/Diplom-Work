...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/gUOQohAxrQM",
    link: "https://www.youtube.com/embed/gUOQohAxrQM",
    title: "  Создание C++ игры с нуля / #1 – Игра «Змейка 2Д» на C++ и WinForms  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right, rgb(60, 187, 133), rgb(179, 10, 114))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(181, 10, 158),rgb(7, 123, 73))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(180, 8, 137), rgb(60, 187, 133), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              Создание C++ игры с нуля
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Li74Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(60, 187, 133)' : 'rgb(180, 8, 114)',
                // color: 'black',
