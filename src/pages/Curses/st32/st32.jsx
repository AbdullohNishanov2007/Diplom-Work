...
const Un32Videos = [
  {
    url: "https://www.youtube.com/embed/2JpT2AkKZt4",  
    link: "https://www.youtube.com/embed/2JpT2AkKZt4",
    title: " GameMaker Studio / Урок #1 - Создание RPG игры ",
...
const Un32 = () => {
  ...
  const totalVideos = Un32Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(28, 169, 0),rgb(126, 0, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(210, 0, 0),rgb(54, 192, 30))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 192, 26),rgb(195, 0, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Уроки GameMaker: Studio 2
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Un32Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 255, 76)' : 'rgb(231, 0, 0)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
