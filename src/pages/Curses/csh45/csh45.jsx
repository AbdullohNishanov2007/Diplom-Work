...
const Csh45Videos = [
  {
    url: "https://www.youtube.com/embed/gp2rA0rgq_0",
    link: "https://www.youtube.com/embed/gp2rA0rgq_0",
    title: "Уроки C# .NET Windows Forms / #1 - Создание приложения на C# с SQL (базами данных)",
...
const Csh45 = () => {
  ...
  const totalVideos = Csh45Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(204, 0, 255),rgb(255, 0, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(150, 0, 0),rgb(110, 0, 135))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(187, 0, 0),rgb(200, 0, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Уроки C# .NET Windows Forms 
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Csh45Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(200, 0, 197)'
                  : '0 4px 15px rgb(199, 0, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(173, 0, 176)' : 'rgba(255, 0, 0, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
