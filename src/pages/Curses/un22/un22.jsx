...
const Un22Videos = [
  {
    url: "https://www.youtube.com/embed/CrShN3zTgWE",  
    link: "https://www.youtube.com/embed/CrShN3zTgWE",
    title: " Как создать Андроид игру на движке Unity? ",
...
const Un22 = () => {
  ...
  const totalVideos = Un22Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 126, 32),rgb(0, 48, 18))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(43, 255, 0),rgb(75, 255, 153))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(18, 105, 0),rgb(131, 255, 185))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Андроид игра на движке Unity
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Un22Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgba(4, 250, 0, 0.7)'
                  : '0 4px 15px rgba(0, 82, 4, 0.5)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgba(0, 255, 38, 0.7)' : 'rgba(0, 83, 0, 0.5)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
