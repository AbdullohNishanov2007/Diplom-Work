...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/-13AMkrSaRc",
    link: "https://www.youtube.com/embed/-13AMkrSaRc",
    title: "#1 – Введение в движок Godot. Почему про него все говорят?",
    ...
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 101, 144),rgb(37, 55, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
               Введение в движок Godot
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
