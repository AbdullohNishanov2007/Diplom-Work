...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/DqkGcI1r6fs",
    link: "https://www.youtube.com/embed/DqkGcI1r6fs",
    title: "Практика React JS #1 – Разработка магазина (eCommerce) с нуля",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right, rgb(216, 216, 216), rgb(60, 187, 133))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(60, 187, 133),rgb(157, 157, 157))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 255, 255), rgb(60, 187, 133), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              Разработка магазина (eCommerce) с нуля
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Li74Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(60, 187, 133)'
                  : '0 4px 15px rgb(96, 96, 96)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(60, 187, 133)' : 'rgb(108, 108, 108)',
                // color: 'black',
