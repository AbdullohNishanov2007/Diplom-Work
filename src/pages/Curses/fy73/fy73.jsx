...
const Fi73Videos = [
  {
    url: "https://www.youtube.com/embed/kkThgsC1tnk",
    link: "https://www.youtube.com/embed/kkThgsC1tnk",
    title: "Изучение Figma (Фигма) с нуля / Урок #1 – Создание дизайна (UI/UX) для начинающих",
...
const Fi73 = () => {
  ...
  const totalVideos = Fi73Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 24, 24),rgb(57, 255, 70))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(0, 170, 0),rgb(192, 0, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 0, 0),rgb(0, 255, 30), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Изучение Figma с нуля
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Fi73Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 255, 0)'
                  : '0 4px 15px rgb(255, 0, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 0, 0)' : 'rgb(34, 255, 0)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
