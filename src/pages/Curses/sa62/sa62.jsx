...
const Sa62Videos = [
  {
    url: "https://www.youtube.com/embed/TOlqVNC86XI",
    link: "https://www.youtube.com/embed/TOlqVNC86XI",
    title: "Препроцессор SASS / Урок #1 - Что такое SASS, SCSS. Установка",
...
const Sa62 = () => {
  ...
  const totalVideos = Sa62Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(222, 57, 255),rgb(255, 57, 57))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(170, 0, 99),rgb(192, 35, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 0, 162),rgb(255, 47, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Препроцессор SASS
          ...
          {Sa62Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 55, 0)' : 'rgb(255, 0, 195)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
