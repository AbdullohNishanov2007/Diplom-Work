...
const Un26Videos = [
  {
    url: "https://www.youtube.com/embed/eaA8HhFLt0s",  
    link: "https://www.youtube.com/embed/eaA8HhFLt0s",
    title: " Дополненная реальность Vuforia AR / #1 - Создание игры в Unity ",
...
const Un26 = () => {
  ...
  const totalVideos = Un26Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 208, 255),rgb(116, 0, 210), rgb(0, 210, 46), rgb(210, 81, 0))',
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            WebkitTextFillColor: "transparent"
                ...
                Vuforia AR - дополненная реальность
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Un26Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 255, 8)'
                  : '0 4px 15px rgb(112, 0, 210)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 255, 26)' : 'rgb(81, 0, 210)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
