...
const Ph40Videos = [
  {
    url: "https://www.youtube.com/embed/srsRU7qN22s",
    link: "https://www.youtube.com/embed/srsRU7qN22s",
    title: "PhotoShop уроки / #1 - Интерфейс программы Фотошоп ",
...
const Ph40 = () => {
  ...
  const totalVideos = Ph40Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(2, 36, 255),rgb(255, 225, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(201, 174, 0),rgb(37, 0, 203))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 64, 255),rgb(255, 230, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                PhotoShop уроки
          ...
          {Ph40Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(219, 153, 0)' : 'rgba(0, 8, 255, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
