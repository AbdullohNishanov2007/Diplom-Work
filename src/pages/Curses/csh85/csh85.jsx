...
const Do72Videos = [
  {
    url: "https://www.youtube.com/embed/2ycBBoqAWdQ",
    link: "https://www.youtube.com/embed/2ycBBoqAWdQ",
    title: "Xamarin Forms C# / Урок #1 – Разработка мобильных приложений с нуля",
...
const Do72 = () => {
  ...
  const totalVideos = Do72Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(24, 86, 255),rgb(57, 156, 255))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(0, 68, 170),rgb(0, 118, 192))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 89, 255),rgb(0, 140, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Разработка мобильных приложений с нуля
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Do72Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 157, 255)'
                  : '0 4px 15px rgb(0, 38, 255)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 153, 255)' : 'rgb(0, 60, 255)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
