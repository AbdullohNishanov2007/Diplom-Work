...
const Me71Videos = [
  {
    url: "https://www.youtube.com/embed/FEwjdBCtCSI",
    link: "https://www.youtube.com/embed/FEwjdBCtCSI",
    title: "WordPress Интернет магазин с нуля / Урок #1 – Создание Ecommerce сайта для начинающих",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            WebkitTextFillColor: "transparent"
                ...
                WordPress Интернет магазин с нуля
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
