...
const Un25Videos = [
  {
    url: "https://www.youtube.com/embed/uTRIpaBgRcw",  
    link: "https://www.youtube.com/embed/uTRIpaBgRcw",
    title: " Уроки Blender с нуля / #1 – Основы программы Blender для начинающих ",
...
const Un25 = () => {
  ...
  const totalVideos = Un25Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 149, 0),rgb(0, 102, 210))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(0, 102, 210),rgb(255, 149, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 123, 255),rgb(255, 149, 0))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Уроки Blender с нуля
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Un25Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(255, 149, 0)'
                  : '0 4px 15px rgb(0, 102, 210)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 149, 0)' : 'rgb(0, 102, 210)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
