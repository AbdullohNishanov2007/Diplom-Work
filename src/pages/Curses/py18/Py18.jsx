...
const Py18Videos = [
  {
    ...
    link: "https://www.youtube.com/embed/34Rp6KVGIEM",
...
const Py18 = () => {
  ...
  const totalVideos = Py18Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 136, 255),rgb(153, 148, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(190, 207, 0),rgb(0, 27, 77))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{ 
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 51, 146),rgb(139, 137, 0))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Py18Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgba(180, 159, 0, 0.7)'
                  : '0 4px 15px rgba(4, 69, 208, 0.5)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgba(166, 153, 4, 0.7)' : 'rgba(4, 45, 94, 0.5)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
