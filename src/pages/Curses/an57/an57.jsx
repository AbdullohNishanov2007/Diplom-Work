...
const An57Videos = [
  {
    url: "https://www.youtube.com/embed/-KdtVcdevoI",
    link: "https://www.youtube.com/embed/-KdtVcdevoI",
    title: "Разработка Андроид программы / #1 - Дизайн, база данных (Firebase)",
...
const An57 = () => {
  ...
  const totalVideos = An57Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(57, 206, 255),rgb(255, 57, 149))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(255, 0, 119),rgb(0, 191, 255))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 191, 255),rgb(255, 0, 119), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Разработка Андроид программы
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {An57Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 0, 149)' : 'rgb(0, 191, 255)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
