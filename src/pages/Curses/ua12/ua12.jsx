...
const ua12Videos = [
  {
    url: "https://www.youtube.com/embed/of3sjWOr19U",
    link: "https://www.youtube.com/embed/of3sjWOr19U",
    title: " Создание 2D игры ",
    description: "⏳ 4 минут 👀 40+ тыс. просмотров"
  }
];
...
const Ua12 = () => {
  ...
  const totalVideos = ua12Videos.length;
  const totalDuration = "4 минут";
  const totalViews = "40+ тыс.";

  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(35, 171, 1),rgb(43, 92, 1))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(29, 173, 0),rgb(88, 248, 136))",
          ...
          {ua12Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgba(115, 255, 0, 0.7)'
                  : '0 4px 15px rgba(0, 255, 38, 0.5)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgba(115, 255, 0, 0.7)' : 'rgba(0, 255, 38, 0.5)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
