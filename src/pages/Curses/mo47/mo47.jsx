...
const Mo47Videos = [
  {
    url: "https://www.youtube.com/embed/xwr3azx0Gf0",
    link: "https://www.youtube.com/embed/xwr3azx0Gf0",
    title: "Изучение MongoDB / #1 - Установка базы данных",
...
const Mo47 = () => {
  ...
  const totalVideos = Mo47Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(153, 255, 0),rgb(43, 255, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(0, 150, 57),rgb(90, 135, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 187, 12),rgb(102, 255, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Изучение MongoDB
          ...
          {Mo47Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 200, 7)'
                  : '0 4px 15px rgb(123, 199, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(15, 176, 0)' : 'rgba(119, 255, 0, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
