...
const Asp59Videos = [
  {
    url: "https://www.youtube.com/embed/U4nNZS1bnj8",
    link: "https://www.youtube.com/embed/U4nNZS1bnj8",
    title: "Изучение ASP.NET Core MVC / #1 - Создание сайта на C#",
...
const Asp59 = () => {
  ...
  const totalVideos = Asp59Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(225, 57, 255),rgb(57, 245, 255))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(0, 182, 199),rgb(150, 0, 192))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(234, 0, 255),rgb(0, 255, 242), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Asp59Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 221, 255)'
                  : '0 4px 15px rgb(255, 0, 191)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(242, 0, 255)' : 'rgb(0, 255, 179)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
