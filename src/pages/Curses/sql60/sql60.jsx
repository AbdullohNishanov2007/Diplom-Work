...
const Sql60Videos = [
  {
    url: "https://www.youtube.com/embed/lapMmGGFS7k",
    link: "https://www.youtube.com/embed/lapMmGGFS7k",
    title: "Уроки SQL для начинающих / #1 - Что такое SQL? Введение",
...
const Sql60 = () => {
  ...
  const totalVideos = Sql60Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(57, 110, 255),rgb(57, 245, 255))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(0, 156, 170),rgb(0, 96, 192))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 213, 255),rgb(0, 81, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Sql60Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 106, 255)' : 'rgb(0, 255, 179)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
