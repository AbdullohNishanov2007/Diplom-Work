...
const Csh64Videos = [
  {
    url: "https://www.youtube.com/embed/jgAVGtkk03Q",
    link: "https://www.youtube.com/embed/jgAVGtkk03Q",
    title: "Изучение Flask / #1 - Создание веб сайтов на Python",
...
const Csh64 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(57, 123, 255),rgb(255, 229, 57))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(170, 122, 0),rgb(0, 77, 192))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 76, 255),rgb(255, 196, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Создание веб сайтов на Python
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Csh64Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 128, 255)'
                  : '0 4px 15px rgb(255, 217, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 68, 255)' : 'rgb(255, 204, 0)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
