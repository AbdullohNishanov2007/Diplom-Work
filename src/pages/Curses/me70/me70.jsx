...
const Me70Videos = [
  {
    url: "https://www.youtube.com/embed/RIo9WfOZMx4",
    link: "https://www.youtube.com/embed/RIo9WfOZMx4",
    title: "Изучение стека MEAN / #1 - Создание сайта на Mongo, Express, Node и Angular",
...
const Me70 = () => {
  ...
  const totalVideos = Me70Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 120, 2),rgb(255, 123, 57),rgb(255, 57, 126), rgb(0, 120, 2))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(0, 120, 2), rgb(170, 0, 99),rgb(192, 67, 0),rgb(0, 120, 2))",
