...
const Ja34Videos = [
  {
    url: "https://www.youtube.com/embed/AfbBTQLxNfE",  
    link: "https://www.youtube.com/embed/AfbBTQLxNfE",
    title: " Уроки Android Studio с нуля / #1 – Разработка Андроид приложений для начинающих ",
...
const Ja34 = () => {
  ...
  const totalVideos = Ja34Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(28, 169, 0),rgb(0, 42, 255))',
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 192, 26),rgb(58, 61, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Ja34Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 255, 76)' : 'rgb(0, 47, 255)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
