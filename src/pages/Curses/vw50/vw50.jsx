...
const Vw50Videos = [
  {
    url: "https://www.youtube.com/embed/46q2eB7xvXA",
    link: "https://www.youtube.com/embed/46q2eB7xvXA",
    title: "Bootstrap верстка современного сайта за 45 минут!",
...
const Vw50 = () => {
  ...
  const totalVideos = Vw50Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(21, 0, 255),rgb(212, 0, 255))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(135, 0, 150),rgb(7, 0, 135))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 23, 137),rgb(195, 0, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Bootstrap верстка современного сайта
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Vw50Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(133, 0, 200)'
                  : '0 4px 15px rgb(0, 17, 199)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(163, 0, 200)' : 'rgba(0, 8, 255, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
