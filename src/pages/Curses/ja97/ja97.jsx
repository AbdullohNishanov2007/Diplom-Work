...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/letMIfa2RW4",
    link: "https://www.youtube.com/embed/letMIfa2RW4",
    title: "  Разработка игры на Java / #1 – Как сделать игру на JavaFx?  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(179, 165, 10), rgb(25, 80, 190), rgb(179, 10, 10))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(142, 131, 9), rgb(16, 56, 137), rgb(131, 8, 8))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(180, 166, 8), rgb(187, 60, 98), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Li74Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(220, 193, 37)' : 'rgb(180, 8, 8)',
                // color: 'black',
