...
const Ja68Videos = [
  {
    url: "https://www.youtube.com/embed/YPRaA6KhyXc",
    link: "https://www.youtube.com/embed/YPRaA6KhyXc",
    title: "   Уроки Flutter и Dart с нуля / #1 – Разработка мобильных приложений для начинающих  ",
...
const Ja68 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 137, 0),rgb(156, 57, 255))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(88, 0, 143),rgb(17, 144, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(144, 0, 255),rgb(31, 143, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Ja68Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(8, 157, 0)' : 'rgb(255, 0, 247)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
