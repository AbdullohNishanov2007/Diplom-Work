...
const Un24Videos = [
  {
    url: "https://www.youtube.com/embed/dWAL0ISKk-E",  
    link: "https://www.youtube.com/embed/dWAL0ISKk-E",
    title: " Unreal Engine 5 с нуля / Урок #1 - Создание игр на UE для начинающих ",
...
const Un24 = () => {
  ...
  const totalVideos = Un24Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 100, 115),rgb(0, 196, 210))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(36, 208, 255),rgb(0, 75, 90))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 93, 105),rgb(1, 110, 118))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Un24Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgba(0, 217, 250, 0.7)'
                  : '0 4px 15px rgba(0, 75, 82, 0.5)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgba(0, 213, 255, 0.7)' : 'rgba(0, 77, 83, 0.5)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
