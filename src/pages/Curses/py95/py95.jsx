...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/OcrEMgx7OjE",
    link: "https://www.youtube.com/embed/OcrEMgx7OjE",
    title: "  Изучение Python UI (GUI Apps) / #1 – Разработка программ с графическим интерфейсом на Питон  ",
    ...
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(153, 9, 9),rgb(15, 151, 37))",
