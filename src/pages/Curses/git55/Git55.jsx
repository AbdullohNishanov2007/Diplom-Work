...
const Git55Videos = [
  {
    url: "https://www.youtube.com/embed/bkNCylkzFRk",
    link: "https://www.youtube.com/embed/bkNCylkzFRk",
    title: "Изучение Git для новичков / #1 - Что такое Git, установка и настройка",
...
const Git55 = () => {
  ...
  const totalVideos = Git55Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 57, 149),rgb(0, 144, 173))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(0, 92, 110),rgb(173, 0, 81))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 92, 110),rgb(173, 0, 121), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Git55Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 0, 149)' : 'rgb(0, 92, 110)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
