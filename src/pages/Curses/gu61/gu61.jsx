...
const Gu61Videos = [
  {
    url: "https://www.youtube.com/embed/dsHWWuWnuMA",
    link: "https://www.youtube.com/embed/dsHWWuWnuMA",
    title: "Изучение Gulp.JS / Урок #1 - Что такое Gulp 4. Установка",
...
const Gu61 = () => {
  ...
  const totalVideos = Gu61Videos.length;
          ...
          {Gu61Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 98, 0)' : 'rgb(255, 0, 195)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
