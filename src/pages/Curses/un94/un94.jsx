...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/JXjnOKqC4jA",
    link: "https://www.youtube.com/embed/JXjnOKqC4jA",
    title: "  Курс UNITY разработки с нуля / Урок #1 – Создание 3D Android/iOS игры. Как создать свою ИГРУ?  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right, rgb(58, 78, 181), rgb(179, 100, 10))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(155, 82, 8),rgb(0, 67, 154))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(180, 74, 8), rgb(60, 92, 187), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              Курс UNITY разработки с нуля 
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Li74Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(213, 109, 24)'
                  : '0 4px 15px rgb(8, 97, 165)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(220, 125, 30)' : 'rgb(8, 91, 180)',
                // color: 'black',
