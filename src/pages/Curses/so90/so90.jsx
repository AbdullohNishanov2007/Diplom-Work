...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/t_EmyKgniKI",
    link: "https://www.youtube.com/embed/t_EmyKgniKI",
    title: "  Крипто разработка на Solidity / Урок #1 – Введение в криптовалюты. Создание монеты  ",
          ...
          {Li74Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(60, 187, 133)' : 'rgb(13, 8, 180)',
                // color: 'black',
