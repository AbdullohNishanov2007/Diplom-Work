...
const Un65Videos = [
  {
    url: "https://www.youtube.com/embed/GGsOU7sP0r4",
    link: "https://www.youtube.com/embed/GGsOU7sP0r4",
    title: "Разработка игры на Unity / Урок #1 - Введение в Unity GameDev",
...
const Un65 = () => {
  ...
  const totalVideos = Un65Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(224, 224, 224),rgb(157, 157, 157))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(101, 101, 101),rgb(154, 154, 154))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(204, 204, 204),rgb(111, 111, 111), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Un65Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(208, 208, 208)'
                  : '0 4px 15px rgb(119, 119, 119)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(229, 229, 229)' : 'rgb(105, 105, 105)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
