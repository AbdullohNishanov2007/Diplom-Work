...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/O0W3cbgrFfg",
    link: "https://www.youtube.com/embed/O0W3cbgrFfg",
    title: "  Nuxt JS с нуля / #1 – Что такое Nuxt.js? Введение в фреймворк  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right, rgb(58, 181, 66), rgb(179, 100, 10))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(155, 82, 8),rgb(0, 154, 8))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(180, 74, 8), rgb(60, 187, 68), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              Nuxt JS с нуля 
          ...
          {Li74Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(220, 125, 30)' : 'rgb(8, 180, 19)',
                // color: 'black',
