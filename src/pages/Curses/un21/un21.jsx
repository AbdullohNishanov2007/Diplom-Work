...
const Un21Videos = [
  {
    url: "https://www.youtube.com/embed/k9SwHzNDWYI",  
    link: "https://www.youtube.com/embed/k9SwHzNDWYI",
    title: " Уроки C# Unity / #1 – Изучаем C# в Unity с нуля",
...
const Un21 = () => {
  ...
  const totalVideos = Un21Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(48, 48, 48),rgb(74, 74, 74))',
          ...
          {Un21Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgba(203, 203, 203, 0.7)'
                  : '0 4px 15px rgba(80, 80, 80, 0.5)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgba(255, 255, 255, 0.7)' : 'rgba(61, 61, 61, 0.5)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
