...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/t6rey_W_Clo",
    link: "https://www.youtube.com/embed/t6rey_W_Clo",
    title: "  Уроки Java 3D Game / #1 – Создание Minecraft игры с нуля на Джава  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right, rgb(60, 187, 133), rgb(10, 78, 179))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(10, 47, 181),rgb(7, 123, 73))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(8, 88, 180), rgb(60, 187, 133), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              Создание Minecraft игры с нуля на Джава
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Li74Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(60, 187, 133)' : 'rgb(8, 74, 180)',
                // color: 'black',
