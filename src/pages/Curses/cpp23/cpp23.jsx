...
const Un22Videos = [
  {
    url: "https://www.youtube.com/embed/6qaAZTwemXY",  
    link: "https://www.youtube.com/embed/6qaAZTwemXY",
    title: " Создание игры на C++ / Змейка - Урок #1 (Создание карты) ",
...
const Un22 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(86, 0, 126),rgb(0, 60, 97))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(0, 51, 255),rgb(68, 0, 171))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 25, 105),rgb(115, 0, 187))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Создание игры на C++
          ...
          {Un22Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgba(112, 0, 250, 0.7)'
                  : '0 4px 15px rgba(0, 14, 82, 0.5)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgba(98, 0, 255, 0.7)' : 'rgba(0, 21, 83, 0.5)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
