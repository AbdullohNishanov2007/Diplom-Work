...
const Un17Videos = [
  {
    url: "https://www.youtube.com/embed/DRIpWbl-qK8",
    link: "https://www.youtube.com/embed/DRIpWbl-qK8",
    title: " Unity ios ",
...
const Un17 = () => {
  ...
  const totalVideos = Un17Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(51, 255, 0),rgb(0, 59, 153))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(3, 40, 151),rgb(1, 111, 6))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{ 
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 146, 2),rgb(0, 24, 58))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Unity ios
          ...
          {Un17Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgba(4, 85, 166, 0.7)' : 'rgba(4, 94, 37, 0.5)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
