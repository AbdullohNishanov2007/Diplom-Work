...
const Cpp46Videos = [
  {
    url: "https://www.youtube.com/embed/P5Lah3YlkpQ",
    link: "https://www.youtube.com/embed/P5Lah3YlkpQ",
    title: "Полное изучение C++ / Курс в одном видео для начинающих с нуля",
...
const Cpp46 = () => {
  ...
  const totalVideos = Cpp46Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 221, 255),rgb(0, 81, 255))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(0, 67, 150),rgb(0, 106, 135))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 118, 187),rgb(0, 42, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Полное изучение C++
          ...
          {Cpp46Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 190, 200)'
                  : '0 4px 15px rgb(0, 23, 199)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 132, 176)' : 'rgba(0, 38, 255, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
