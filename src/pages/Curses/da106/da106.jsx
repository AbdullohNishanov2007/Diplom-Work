...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/MVtrwcrdRgY",
    link: "https://www.youtube.com/embed/MVtrwcrdRgY",
    title: "  Python Data Analytics / Урок #1 – Курс по аналитике данных на Питоне (NumPy, Pandas, Matplotlib)  ",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            WebkitTextFillColor: "transparent"
              ...
              Курс по аналитике данных на Питоне
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
