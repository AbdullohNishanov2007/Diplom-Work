...
const jqueryVideos = [
  {
    url: "https://www.youtube.com/embed/eexjaaFlOPY" ,
    link: "https://youtu.be/eexjaaFlOPY?si=GCbKBEGKKWJxJCD_",
    title: "Введение в jQuery для начинающих",
    description: "⏳ 1 час 10 минут 👀 650 тыс. просмотров"
  }
];
...
const JqueryLessons = () => {
  ...
  const totalVideos = jqueryVideos.length;
  const totalDuration = "4.5+ часа";
  const totalViews = "2.7 млн+";
  ...
  return (
    <div style={{ backgroundColor: "#121212", minHeight: '100vh', padding: '0' }}>
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{ fontSize: '40px', textAlign: 'center', marginBottom: '50px' }}>Лучшие уроки по jQuery</h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          gap: '40px',
