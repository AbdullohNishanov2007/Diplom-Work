...
const Js51Videos = [
  {
    url: "https://www.youtube.com/embed/0grybmrgc2Q",
    link: "https://www.youtube.com/embed/0grybmrgc2Q",
    title: "Уроки React JS на практике / #1 - Создание погодного приложения",
...
const Js51 = () => {
  ...
  const totalVideos = Js51Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 221, 255),rgb(255, 119, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(150, 85, 0),rgb(0, 94, 135))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 116, 137),rgb(255, 132, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Уроки React JS на практике
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Js51Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 163, 200)'
                  : '0 4px 15px rgb(199, 129, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 177, 200)' : 'rgba(255, 136, 0, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
