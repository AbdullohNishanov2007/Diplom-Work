...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/mqp7dWk40HI",
    link: "https://www.youtube.com/embed/mqp7dWk40HI",
    title: "  Python Data Science / Урок #1 – Полная обработка данных (Scikit-learn, TensorFlow, PyTorch, Plotly)  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right, rgb(60, 187, 133), rgb(4, 2, 56))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(8, 4, 108),rgb(31, 142, 94))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(14, 8, 180), rgb(60, 187, 133), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              Python Data Science
          ...
          {Li74Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(44, 138, 97)'
                  : '0 4px 15px rgb(8, 73, 165)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(43, 135, 95)' : 'rgb(8, 80, 180)',
                // color: 'black',
