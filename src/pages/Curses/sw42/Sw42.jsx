...
const Sw42Videos = [
  {
    url: "https://www.youtube.com/embed/Yh0jAI7ObmI",
    link: "https://www.youtube.com/embed/Yh0jAI7ObmI",
    title: "Уроки Swift для начинающих / Изучение языка Swift за час!",
...
const Sw42 = () => {
  ...
  const totalVideos = Sw42Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 171, 2),rgb(255, 107, 178))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(159, 0, 177),rgb(189, 132, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(187, 0, 159),rgb(255, 81, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Sw42Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(255, 115, 0)'
                  : '0 4px 15px rgb(242, 3, 255)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(219, 117, 0)' : 'rgba(230, 5, 255, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
