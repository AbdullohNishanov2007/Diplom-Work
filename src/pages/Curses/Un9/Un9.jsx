...
const unityVideos = [
    {
      url: "https://www.youtube.com/embed/xAtoU-FnC7o",
      link: "https://www.youtube.com/embed/xAtoU-FnC7o",
      title: "Unity 3D для начинающих - Полный курс",
      description: "⏳ 4 часа 40 минут 👀 2.8 млн просмотров"
    }
  ];
  ...
  const UnityLessons = () => {
    ...
    const totalVideos = unityVideos.length;
    const totalDuration = "13+ часов";
    const totalViews = "7 млн+";
  
    return (
      <div style={{ backgroundColor: "#121212", minHeight: '100vh', padding: '0' }}>
        <div style={{
          background: 'linear-gradient(to right,rgb(88, 17, 241),rgb(25, 120, 245))',
          ...
          <h1 style={{
            ...
            background: "linear-gradient(to right,rgb(255, 255, 255),rgb(0, 170, 255))",
        ...
        <div style={{ color: "#eee", padding: '60px 20px' }}>
          <h2 style={{ fontSize: '40px', textAlign: 'center', marginBottom: '50px' }}>Лучшие уроки по Unity</h2>
          <div style={{
            display: 'flex',
            flexWrap: 'wrap',
            gap: '40px',
            ...
            {unityVideos.map((video, index) => (
              <div
                ...
                style={{
                  ...
                  boxShadow: hoveredIndex === index
                    ? '0 8px 30px rgba(21, 0, 255, 0.7)'
                    : '0 4px 15px rgba(62, 185, 243, 0.5)',
              ...
              >
                ...
                <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                  marginTop: '15px',
                  padding: '10px 20px',
                  backgroundColor: hoveredIndex === index ? 'rgba(21, 0, 255, 0.7)' : 'rgba(63, 182, 255, 0.5)',
                  color: 'black',
                  borderRadius: '8px',
                  textDecoration: 'none',
                  fontWeight: 'bold',
