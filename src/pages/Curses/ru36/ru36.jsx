...
const Ru36Videos = [
  {
    url: "https://www.youtube.com/embed/LAFjA76huC4",
    link: "https://www.youtube.com/embed/LAFjA76huC4",
    title: " Изучение Ruby On Rails / #1 - Создание веб сайта на Ruby ",
...
const Ru36 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 54, 54),rgb(103, 0, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(255, 0, 0),rgb(255, 49, 49))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 0, 157),rgb(255, 0, 8), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Уроки Ruby On Rails
          ...
          {Ru36Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(255, 0, 0)'
                  : '0 4px 15px rgb(255, 0, 195)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(219, 0, 0)' : 'rgba(255, 107, 250, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
