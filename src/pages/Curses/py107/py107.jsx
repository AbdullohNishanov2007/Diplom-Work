...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/RUddtw-oqFU",
    link: "https://www.youtube.com/embed/RUddtw-oqFU",
    title: "  Изучение FastAPI с нуля / Урок #1 – Что такое Python FastAPI? Введение и установка  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right, rgb(60, 187, 133) 50%, rgb(0, 0, 0)50%)',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(0, 0, 0)50%,rgb(7, 123, 73)50%)",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right, rgb(0, 0, 0)50%, rgb(60, 187, 133)50%)",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              Изучение FastAPI -- с нуля
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Li74Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(60, 187, 133)' : 'rgb(0, 0, 0)',
                color: '#fff',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
