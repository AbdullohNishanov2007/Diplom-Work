...
const Pd49Videos = [
  {
    url: "https://www.youtube.com/embed/_JXbltBvZAs",
    link: "https://www.youtube.com/embed/_JXbltBvZAs",
    title: " Видеокурс по Python, Django и TKInter | Презентация курса ",
...
const Pd49 = () => {
  ...
  const totalVideos = Pd49Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 116, 2),rgb(26, 255, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(7, 201, 0),rgb(203, 78, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 102, 0),rgb(30, 255, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Видеокурс по Python, Django
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Pd49Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 169, 17)' : 'rgba(255, 187, 0, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
