...
const Do72Videos = [
  {
    url: "https://www.youtube.com/embed/dNS61T4MmlM",
    link: "https://www.youtube.com/embed/dNS61T4MmlM",
    title: "Уроки Docker для начинающих / #1 – Контейнеры и введение в Докер. Для чего он нужен?",
          ...
          {Do72Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 81, 255)'
                  : '0 4px 15px rgb(0, 162, 255)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 60, 255)' : 'rgb(0, 140, 255)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
