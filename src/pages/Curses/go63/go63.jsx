...
const Go63Videos = [
  {
    url: "https://www.youtube.com/embed/OcWMQPPOq-0",
    link: "https://www.youtube.com/embed/OcWMQPPOq-0",
    title: "Изучение Golang (Создание веб сайта) / #1 – Введение в язык Go",
...
const Go63 = () => {
  ...
  const totalVideos = Go63Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(57, 235, 255),rgb(255, 57, 57))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(170, 0, 99),rgb(0, 179, 192))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(255, 0, 162),rgb(0, 242, 255), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Введение в язык Go
          ...
          {Go63Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 255, 238)' : 'rgb(255, 0, 195)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
