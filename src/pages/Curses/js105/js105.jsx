...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/bsgypx_JRfQ",
    link: "https://www.youtube.com/embed/bsgypx_JRfQ",
    title: "  3D Дизайн на Three.JS / #1 – Разработка веб 3Д Графики на основе WebGl и Three JS  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right, rgb(60, 100, 187), rgb(66, 10, 179))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(49, 8, 132),rgb(15, 51, 130))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(8, 88, 180), rgb(76, 17, 196), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              3D Дизайн на Three.JS
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Li74Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(49, 8, 132)'
                  : '0 4px 15px rgb(8, 89, 165)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(49, 8, 132)' : 'rgb(8, 74, 180)',
                // color: 'black',
