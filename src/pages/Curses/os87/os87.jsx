...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/aO4Mnz485uM",
    link: "https://www.youtube.com/embed/aO4Mnz485uM",
    title: "Основы программирования / Урок #1 – Введение в программирование с нуля",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(207, 245, 255),rgb(167, 176, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(176, 176, 0),rgb(146, 222, 255))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(149, 223, 255),rgb(176, 158, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Li74Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(149, 221, 255)'
                  : '0 4px 15px rgb(176, 173, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(163, 229, 255)' : 'rgb(170, 176, 0)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
