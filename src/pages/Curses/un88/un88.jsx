...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/IxAzjhTKFtA",
    link: "https://www.youtube.com/embed/IxAzjhTKFtA",
    title: "Создание 3D игры на Unity / Урок #1 – Разработка 3Д стратегии",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(165, 165, 165),rgb(249, 66, 66))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(249, 66, 66),rgb(128, 128, 128))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(113, 113, 113),rgb(249, 66, 66), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Li74Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(249, 66, 66)' : 'rgb(108, 108, 108)',
                // color: 'black',
