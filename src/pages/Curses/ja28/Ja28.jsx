...
const Un28Videos = [
  {
    url: "https://www.youtube.com/embed/plbIWp4F_g0",  
    link: "https://www.youtube.com/embed/plbIWp4F_g0",
    title: " Уроки Java для профессионалов | #1 - Программирование на Java ",
...
const Un28 = () => {
  ...
  const totalVideos = Un28Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(198, 198, 198),rgb(0, 123, 255))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(0, 102, 210),rgb(220, 220, 220))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 123, 255),rgb(224, 224, 224))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Un28Videos.map((video, index) => (
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 72, 255)' : 'rgb(186, 186, 186)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
