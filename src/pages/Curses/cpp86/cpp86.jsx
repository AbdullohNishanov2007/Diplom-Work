...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/TLqipry1o9s",
    link: "https://www.youtube.com/embed/TLqipry1o9s",
    title: "Уроки C++ WinForms / #1 – Разработка программы под Windows на C++",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(25, 209, 255),rgb(176, 0, 138))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(176, 0, 138),rgb(0, 101, 145))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(0, 101, 144),rgb(176, 0, 138), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
               Разработка программы под Windows на C++
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Li74Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(0, 171, 251)'
                  : '0 4px 15px rgb(176, 0, 138)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(0, 183, 255)' : 'rgb(176, 0, 138)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
