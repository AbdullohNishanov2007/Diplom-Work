...
const Csh56Videos = [
  {
    ...
    title: "Уроки C# .NET Windows Forms / #1 - Создание приложения на C#",
...
const Csh56 = () => {
  ...
  const totalVideos = Csh56Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 57, 149),rgb(133, 0, 173))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(92, 0, 110),rgb(173, 0, 81))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(110, 0, 106),rgb(173, 0, 121), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
          ...
          {Csh56Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(255, 0, 111)'
                  : '0 4px 15px rgb(92, 0, 110)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(255, 0, 149)' : 'rgb(77, 0, 110)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
