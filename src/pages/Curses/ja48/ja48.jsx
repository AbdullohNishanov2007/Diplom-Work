...
const Ja48Videos = [
  {
    url: "https://www.youtube.com/embed/gYylK8NudWA",
    link: "https://www.youtube.com/embed/gYylK8NudWA",
    title: "Уроки Андроид программирования | #1 - Введение в Java Android",
...
const Ja48 = () => {
  ...
  const totalVideos = Ja48Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(255, 98, 0),rgb(255, 234, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right,rgb(150, 142, 0),rgb(135, 65, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(187, 115, 0),rgb(217, 255, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Уроки Андроид программирования Изучение MongoDB
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Ja48Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(200, 150, 0)'
                  : '0 4px 15px rgb(186, 199, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(200, 150, 0)' : 'rgba(246, 255, 0, 0.68)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
