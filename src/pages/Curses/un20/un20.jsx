...
const Un20Videos = [
  {
    url: "https://www.youtube.com/embed/rmidcOOhFII",
    link: "https://www.youtube.com/embed/rmidcOOhFII",
    title: " 3D шутер c мультиплеером в Unity / Урок #1 - Начало ",
...
const Un20 = () => {
  ...
  const totalVideos = Un20Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(46, 46, 46),rgb(81, 81, 81))',
