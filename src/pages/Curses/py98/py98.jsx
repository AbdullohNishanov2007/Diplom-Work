...
const Li74Videos = [
  {
    url: "https://www.youtube.com/embed/4wNYHB9frlg",
    link: "https://www.youtube.com/embed/4wNYHB9frlg",
    title: "  Курс по ChatGPT / #1 – Уроки Python ChatGPT API. Что такое ChatGPT и как с ним работать?  ",
...
const Li74 = () => {
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 255, 26), rgb(0, 85, 255), rgb(255, 255, 0))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(0, 114, 23), rgb(0, 38, 113), rgb(131, 127, 8))",
          WebkitBackgroundClip: "text",
          WebkitTextFillColor: "transparent"
        }}>
          Уроки Python ChatGPT API
        </h1>
        <ul style={{
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(14, 180, 8), rgb(187, 174, 60), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
              Что такое ChatGPT и как с ним работать?
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Li74Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(227, 204, 73)'
                  : '0 4px 15px rgb(8, 165, 34)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(220, 193, 37)' : 'rgb(11, 180, 8)',
                // color: 'black',
