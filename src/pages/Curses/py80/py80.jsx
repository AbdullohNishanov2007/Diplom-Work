...
const Ja68Videos = [
  {
    url: "https://www.youtube.com/embed/HuszbTeETYo",
    link: "https://www.youtube.com/embed/HuszbTeETYo",
    title: "Изучение PyQT (Python GUI) / Урок #1 – Создание графического интерфейса на Питон",
...
const Ja68 = () => {
  ...
  const totalVideos = Ja68Videos.length;
  ...
  return (
    <div style={{ backgroundColor: "rgb(47, 47, 47)", minHeight: '100vh', padding: '0' }}>
      <div style={{
        background: 'linear-gradient(to right,rgb(0, 137, 0),rgb(143, 255, 57))',
        ...
        <h1 style={{
          ...
          background: "linear-gradient(to right, rgb(64, 143, 0),rgb(17, 144, 0))",
      ...
      <div style={{ color: "#eee", padding: '60px 20px' }}>
        <h2 style={{
            ...
            textAlign: 'center', 
            marginBottom: '50px',  
            background: "linear-gradient(to right,rgb(0, 77, 159), rgb(47, 255, 0),rgb(31, 143, 0), rgb(0, 66, 1))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent"
            }}>
                Создание графического интерфейса на Питон
            </h2>
        <div style={{
          display: 'flex',
          flexWrap: 'wrap',
          ...
          {Ja68Videos.map((video, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: hoveredIndex === index
                  ? '0 8px 30px rgb(8, 166, 0)'
                  : '0 4px 15px rgb(102, 255, 0)',
            ...
            >
              ...
              <a href={video.link} target="_blank" rel="noopener noreferrer" style={{
                marginTop: '15px',
                padding: '10px 20px',
                backgroundColor: hoveredIndex === index ? 'rgb(8, 157, 0)' : 'rgb(119, 255, 0)',
                color: 'black',
                borderRadius: '8px',
                textDecoration: 'none',
                fontWeight: 'bold',
